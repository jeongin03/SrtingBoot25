...
public class BoardRepositoryTests {
    ...
    public  void testInsert(){
        ...
        IntStream.rangeClosed(1,100).forEach(i ->{
            ...
            //                            .save 메서드는 jpa에서 상속한 메서드로 값을 저장 하는 용도
    ...
    public void testSelect(){
        long bno = 100l; // 게시물에 번호가 100인 개체를 확인 해보자.
    ...
    public  void testUpdate(){
        ...
        boardRepository.save(board); // .save 메서드는 pk값이 없으면 insert, pk가 없으면 update
    ...
    public  void testDelete(){
        ...
        //             .delete(bno) -> delete from board where bno =bno
    ...
    public void testPaging(){
        ...
        // 1장에 종이에 Board객체를 가지고 있는 결과는 result에 담긴다.
